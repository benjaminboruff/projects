<header>
    <div class="bg-gray-600 shadow-lg">
        <nav class="flex flex-row">
            <div id="menu-arrow" class="mx-4 my-5 lg:hidden">
                <svg class="lg:invisible fill-current text-orange-300 " viewBox='0 0 140 140' width='24' height='24' xmlns='http://www.w3.org/2000/svg'>
                    <g>
            ...
            <div class="mt-3 mb-2 pr-14 flex-grow lg:p-4">
                ...
                <div class="text-center text-xs tracking-wide text-orange-300">Developer</div>
            </div>
        </nav>
    </div>
</header>
