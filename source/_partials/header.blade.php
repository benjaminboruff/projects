    ...
    <div class="bg-gray-600 shadow-lg">
        <nav class="flex flex-row">
            <div class="p-4 md:hidden">
                <svg id="menu-arrow" class="md:invisible fill-current text-yellow-200 transition duration-500 transform" viewBox='0 0 140 140' width='24' height='24' xmlns='http://www.w3.org/2000/svg'>
                    <g>
