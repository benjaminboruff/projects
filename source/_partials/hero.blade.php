<div class="left-0 relative top-0 w-full z-10">
    <div class="md:hidden bg-center bg-cover bg-no-repeat">
        <img class="opacity-40 h-full left-0 top-0 w-full z-20" src="/assets/images/heroweb-narrow.webp" alt="hero">
    </div>
